...
public class DBManager
{
   ...
   public static List<Product> GetAllProducts()
   {
    List<Product> allProducts = new List<Product>();
          ...
          File.WriteAllText(path,ProdJson);
   ...
   public static List<Product> GetAllProductsFromFile(string path)
   {
      if( true)
      {
         ...
         //  var ProdJson= JsonSerializer.Serialize<List<Product>>(allProducts,opt);
         //  File.WriteAllText(path,ProdJson);
         string deserial = System.IO.File.ReadAllText(path);
          List<Product> allProducts = JsonSerializer.Deserialize<List<Product>>(deserial);
          return allProducts;
